            ...
            <main className="mt-20 p-4 sm:p-6 lg:p-8">
                <div className="max-w-4xl mx-auto">
                    <div className="mb-8 text-center md:text-left">
                        <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-2">Cadastrar Novo Paciente</h3>
                        <p className="mt-1 text-base sm:text-lg text-slate-600">Preencha o formulário para registrar um novo paciente no sistema.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="bg-white p-6 rounded-xl shadow-md space-y-6">
                        ...
                        <div className="border-t pt-6">
                             ...
                             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <select id="escolaridade" name="escolaridade" value={formData.escolaridade} onChange={handleChange} className={inputStyle}>
