                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
                        <div className="text-center md:text-left">
                            <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-2">Pacientes Disponíveis</h3>
                            <p className="mt-1 text-base sm:text-lg text-slate-600">Assuma novos pacientes para realizar acompanhamento.</p>
                        </div>
